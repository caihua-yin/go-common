...
func Bind(req *http.Request, obj interface{}) error {
	...
	case "application/json", "application/x-amz-json-1.1":
	...
	err = parseRequestBinding(req, obj)
	if err != nil {
		return err
	}
...
// Validate checks structure for completeness/correctness
